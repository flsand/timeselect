...
public class NumberPickerView extends View {
    ...
    public void setValue(int value) {
        if (value < mMinValue) {
            throw new IllegalArgumentException("should not set a value less than mMinValue, value is " + value + " mMinValue is " + mMinValue)
            ;
        }
        if (value > mMaxValue) {
            throw new IllegalArgumentException("should not set a value larger than mMaxValue, value is " + value + " mMaxValue is " + mMaxValue);
        }
